<template>
  <div class="rst-activity">
    ...
    <div class="activity-count">
      <span @click="showSheet=true">{{activities.length}}个优惠</span>
    ...
    <transition name="fade">
      <div class="act-model" v-show="showSheet">
        <div class="activity-sheet">
          ...
          <h2>优惠活动</h2>
          <ul>
            <li v-for="(items,index) in activities" :key="index">
              <span :style="{background:'#'+activities[0].icon_color}">{{items.icon_name}}</span>
