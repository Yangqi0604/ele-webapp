<template>
    <div>   
         <div class="tableware">
			...
			<div class="offer_item">
				<div class="offer_item_title">发票信息</div>
					<div class="offer_item_text">
			...
			<div class="offer_item">
					<div class="offer_item_title">号码保护</div>
						<div class="offer_item_p">
							<p>号码保护中,骑手隐藏您的真实手机号</p>
						</div>
