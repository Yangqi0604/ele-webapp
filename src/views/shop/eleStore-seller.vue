...
.seller .delivery .message h3 {
  font-weight: 700;
  line-height: 2.8rem;
}
.seller .delivery .message ul {
  font-size: 0.8125rem;
  line-height: 1.5rem;
...
.seller .action .merchant {
  width: 90%;
  margin: 0 auto;
}
.seller .action .merchant h3 {
  font-weight: 700;
  line-height: 2.8rem;
}
.seller .action .photo {
