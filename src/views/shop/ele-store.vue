<template>
  <div class="shop" v-if="shopInfo">
    ...
    <div class="index-rst">
      <div class="rst-name">
        <span @click="shopInfolmodel=true">{{shopInfo.rst.name}}</span>
        <i class="fa fa-caret-right"></i>
      </div>
      <!-- 弹窗 -->
      <InfoModle
        @close="shopInfolmodel=false"
        :rst="shopInfo.rst"
        :shopInfolmodel="shopInfolmodel"
      />
      <!-- 评分月售 -->
      <div class="rst-order">
...
<script>
import InfoModle from "../../components/ele-store/infoModle";
import Activity from "../../components/ele-store/Activity";
import NavBar from "../../components/ele-store/navbar";
export default {
  name: "shop",
  components: {
    InfoModle,
