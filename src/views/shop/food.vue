<template>
  <transition name="move">
    <!-- 不建议使用@click="handleclick" -->
    <!-- 避免直接改变道具，因为只要父组件重新渲染，该值就会被覆盖。 而是根据prop的值使用数据或计算属性。 -->
      ...
      <div class="foodpanel-body">
        ...
        <div class="foodpanel-foodinfo">
          ...
          <div class="foodpanel-priceLine">
            ...
            <cartcontrol :food="food" class="cart-btn" />
          </div>
...
<script>
import cartcontrol from "../../components/ele-store/cartcontrol";
export default {
  name: "Food",
  props: {
    food: Object,
